describe('OMDB Data Service', function(){
    ...
    var omdbDataService , $httpBackend, response;
    ...
    beforeEach(angular.mock.inject(
        function(_omdbDataService_, _$httpBackend_){ 
    ...
    it('should return search movie data', function(){
        ...
        // Act
        omdbDataService.search('star wars').then(
            function(data)  {
                response = data.data;
            }
        );
    ...
    it('should return movie data by id', function(){
        ...
        // Act
        omdbDataService.find('tt0076759').then(
            function(data)  {
                response = data.data;
            }
        );
    ...
    it('should handle error', function(){
        ...
        // Act
        omdbDataService.find('tt007679').then(
            function(data)  {
                response = data;
            }
        );
