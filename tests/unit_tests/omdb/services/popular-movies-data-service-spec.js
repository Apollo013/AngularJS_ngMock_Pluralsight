describe('Popular Movies Data Service', function(){
    var popularMoviesDataService, $httpBackend;

    beforeEach(angular.mock.module('omdb'));

    beforeEach(angular.mock.inject(
        function(_PopularMovieDataService_, _$httpBackend_){
            popularMoviesDataService = _PopularMovieDataService_;
    ...
    it('Should create popular movie', function(){
        ...
        var popularMovie = new popularMoviesDataService({
            movieId: 'tt0076759',
    ...
    it('should get movie by id (checking url)', function(){
        ...
        */
        ...
        popularMoviesDataService.get({movieId: 'tt0076759'});
    ...
    it('should authenticate all requests', function(){
        ...
        popularMoviesDataService.query();
        popularMoviesDataService.get({ movieId: 'tt0076759' });
        new popularMoviesDataService(popularMoviesDataService).$save();
        new popularMoviesDataService(popularMoviesDataService).$update();
        new popularMoviesDataService(popularMoviesDataService).$remove();
