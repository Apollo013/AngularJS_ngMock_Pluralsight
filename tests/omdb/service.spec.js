describe('omdb service', function(){
    ...
    beforeEach(angular.mock.inject(function(_omdbApi_){ omdbApi = _omdbApi_; }));
    ...
    it('should return movie data by id', function(){
        // Act -> Assert
        expect(omdbApi.searchById('tt0076759')).toEqual(movieData2);
    });
});